...
<section class="media-library" aria-label="Imágenes disponibles">
    @forelse($assets as $asset)
        ...
        <article class="media-card">
            ...
            <form method="POST" action="{{ route('admin.media.destroy', $asset) }}" data-confirm="¿Eliminar esta imagen? Esta acción también borra el archivo.">@csrf @method('DELETE')<button class="media-delete" type="submit">Eliminar imagen</button></form>
        </article>
    @empty
